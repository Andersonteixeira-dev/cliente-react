...
const initialState = {
    ...
    salario: '', prazo: '', estado: '', resumo: '', cargos: '', links: []
};
        ...
        <div>
            ...
            <section className="form-section">
                ...
                <form onSubmit={handleSalvar}>
                    ...
                    <div className="form-group"><label>Escolaridade</label><div className="checkbox-group">{['Nível Fundamental', 'Nível Médio', 'Nível Superior'].map(nivel => (<label key={nivel}><input type="checkbox" value={nivel} checked={(formData.escolaridade || []).includes(nivel)} onChange={handleEscolaridadeChange} /> {nivel}</label>))}</div></div>
