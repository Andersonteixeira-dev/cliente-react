...
function GerenciarConcursos() {
    ...
    const handleResumoChange = (content, editor) => {
        setFormData(prev => ({ ...prev, resumo: content }));
    };
    ...
    return (
        <>
            <Title>Painel Gerenciar Concursos | eConcursou</Title>
                ...
                <section className="form-section">
                    ...
                    <form onSubmit={handleSalvar}>
                        ...
                        <div className="form-group">
                            ...
                            onEditorChange={handleResumoChange}
                            init={{
                                height: 300,
                                menubar: false,
...
export default GerenciarConcursos;
